...
BLOOM_LEVEL_PROMPT = {
    "remember": """Given the following content:
                {context}
                Generate a question that tests the recall of basic facts, definitions, concepts, or principles.
                Include a suggested answer.
                Format: Question: <question>
                Suggested Answer: <answer>""",
    "understand": """Given the following content:
                {context}
                Generate a question that requires explaining ideas or concepts in their own words.
                Include a suggested answer.
                Format: Question: <question>
                Suggested Answer: <answer>""",
    "apply": """Given the following content:
                {context}
                Generate a question that requires applying learned information to solve a problem or new situation.
                Include a suggested answer.
                Format: Question: <question>
                Suggested Answer: <answer>""",
    "analyze": """Given the following content:
                {context}
                Generate a question that requires breaking down information and establishing relationships between concepts.
                Include a suggested answer.
                Format: Question: <question>
                Suggested Answer: <answer>""",
    "evaluate": """Given the following content:
                {context}
                Generate a question that requires making judgments or evaluating outcomes based on criteria.
                Include a suggested answer.
                Format: Question: <question>
                Suggested Answer: <answer>""",
    "create": """Given the following content:
                {context}
                Generate a question that requires creating something new or proposing alternative solutions.
                Include a suggested answer.
                Format: Question: <question>
                Suggested Answer: <answer>""",
}
