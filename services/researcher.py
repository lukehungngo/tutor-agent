...
class Researcher:
    ...
    def research(self, state: Dict) -> Dict:
        ...
        try:
            ...
            last_message = messages[-1].content if hasattr(messages[-1], 'content') else messages[-1]
            ...
            for step in response.get("intermediate_steps", []):
                ...
                if isinstance(result, str) and any(tool.name in action.tool for tool in self.tools):
