...
event = math_team.quick_math_agent.call_model({"messages": [{"role": "user", "content": user_input}]})
print("Quick Math Agent")
print(event)

print("Deep Math Agent")
event = math_team.deep_math_agent.call_model({"messages": [{"role": "user", "content": user_input}]})
print(event)
